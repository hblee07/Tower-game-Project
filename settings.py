...
ENEMY_STATS = {
    ...
    # 로켓 일반: 이동 속도 빠른 편
    'rocket_normal': {'hp': 60, 'speed': 100, 'gold': 20, 'damage': 1, 'color': (100, 100, 255), 'is_boss': False},
    ...
    'boss_rocket': {'hp': 120, 'speed': 110, 'gold': 150, 'damage': 30, 'color': (50, 50, 200), 'is_boss': True},
    # 팩맨 보스: 타워 먹는 특수 능력
