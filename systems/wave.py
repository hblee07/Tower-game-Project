...
WAVES = [
    [('ghost_normal', 10), ('boss_rocket', 1)],
    [('rocket_normal', 15), ('boss_pacman', 1)],
    [('pacman_normal', 10), ('boss_ghost_sequence', 1)], # 유령 보스 4종류 큐 예약
    [('rocket_normal', 10), ('pacman_normal', 10), ('boss_pacman', 1), ('boss_rocket', 1)],
...
class WaveManager:
    def __init__(self, economy=None, stage_id=1):
        ...
        self.boss_spawn_interval = 0.4 # 유령 보스 연속 스폰 간격
        self.active = False
